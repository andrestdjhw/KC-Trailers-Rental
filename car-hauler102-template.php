<?php
/**
 * Template Name: Trailer — Car Hauler 102
 * Página individual del remolque (URL sugerida: /car-hauler-102).
 * Asignar en: editor de la página → Atributos de página → Plantilla.
 * SEO (configurar en el plugin SEO o ajustes de la página):
 *   Title: Wide Car Hauler Trailer Rental 102" | Duluth, GA | KC Trailer Rentals
 *   Meta:  Rent a 102" x 20' Load Trail car hauler with drive-over fenders
 *          (9,990 lb GVWR, 12k winch) in Duluth, GA. For wider vehicles. 24/7.
 */
...
$trailer_image   = '/wp-content/uploads/2026/06/car-hauler-102.jpg';   // 1 → hero
$trailer_image_2 = '/wp-content/uploads/2026/06/car-hauler-102-2.jpg'; // 2 → bloque "About"
...
$best_for = array(
  'Trucks, SUVs and wider vehicles',
  'Buying or selling larger vehicles',
  'Non-running or low vehicles',
  'Heavier vehicle transport',
);

$included = array(
  'Drive-over fenders',
  '12,000 lb winch',
  'Ramp extension for low cars',
    ...
    <div class="grid items-center gap-12 lg:grid-cols-2">
      <div>
        <span class="text-[13px] font-semibold uppercase tracking-[0.28em] text-[#D7282F]">
          Car Hauler · Duluth, GA
        </span>
        <h1 class="mt-4 font-display text-4xl font-bold uppercase leading-[1.05] tracking-tight text-white sm:text-5xl">
          Car Hauler 102"<br>— Extra Width for Bigger Vehicles.
        </h1>
        <p class="mt-5 max-w-xl text-lg leading-relaxed text-[#C7CDD3]">
          Drive-over fenders and a full 102" width for trucks and SUVs. 12k winch, ramp
          extension, ready 24/7.
        </p>
        ...
        <div class="mt-7 flex flex-wrap gap-x-6 gap-y-2 text-[14px] font-semibold uppercase tracking-wide text-[#9AA4AE]">
          <span>9,990 lb GVWR</span>
          <span class="text-[#D7282F]">·</span>
          <span>102" × 20' · drive-over fenders</span>
        </div>
      </div>
      ...
      <div class="aspect-[4/3] w-full overflow-hidden rounded-xl border border-white/10 bg-[#11161B] bg-cover bg-center shadow-2xl"
           ...
           role="img" aria-label="Load Trail car hauler 102 inch by 20 foot with drive-over fenders"></div>
    </div>
  </div>
...
<section class="bg-[#F4F2ED] py-20">
  <div class="mx-auto grid max-w-6xl items-center gap-12 px-6 lg:grid-cols-2">
    ...
    <div class="relative aspect-[4/3] w-full overflow-hidden rounded-xl border border-[#1B2127]/10 shadow-xl">
      ...
      <img src="<?php echo esc_url($trailer_image_2); ?>" alt="Load Trail 102 inch car hauler detail" loading="lazy"
    ...
    <div>
      ...
      <h2 class="mt-3 font-display text-3xl font-bold uppercase tracking-tight text-[#1B2127] sm:text-4xl">
        Our widest car hauler
      </h2>
      <p class="mt-5 text-lg leading-relaxed text-[#5B6670]">
        Our widest car hauler. The drive-over fenders and 102" deck give you room for trucks,
        SUVs and wider vehicles, while the 12,000 lb winch and ramp extension make loading
        simple — even for low or non-running vehicles.
      </p>
    </div>
  </div>
</section>
...
<section class="bg-[#1B2127] py-20">
  <div class="mx-auto max-w-5xl px-6 text-center">
    ...
    <h2 class="mt-3 font-display text-3xl font-bold uppercase tracking-tight text-white sm:text-4xl">
      9,990 lb GVWR · 102" × 20'
    </h2>
    <p class="mt-3 text-[15px] text-[#9AA4AE]">drive-over fenders · 12k lb winch · ramp extension</p>
    <div class="mt-10 grid gap-5 sm:grid-cols-3">
      <div class="rounded-lg border border-white/10 bg-[#11161B] p-6">
        <div class="font-display text-4xl font-bold text-[#D7282F]">$110</div>
        <div class="mt-1 text-[14px] font-semibold uppercase tracking-wide text-[#C7CDD3]">Mon–Thu (24h)</div>
      </div>
      <div class="rounded-lg border border-white/10 bg-[#11161B] p-6">
        <div class="font-display text-4xl font-bold text-[#D7282F]">$130</div>
        <div class="mt-1 text-[14px] font-semibold uppercase tracking-wide text-[#C7CDD3]">Fri–Sun (24h)</div>
      </div>
      <div class="rounded-lg border border-white/10 bg-[#11161B] p-6">
        <div class="font-display text-4xl font-bold text-[#D7282F]">$25</div>
