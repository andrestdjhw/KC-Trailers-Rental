<?php
/**
 * Template Name: Trailer — Load Trail Dump
 * Página individual del remolque (URL sugerida: /load-trail-dump).
 * Asignar en: editor de la página → Atributos de página → Plantilla.
 * SEO (configurar en el plugin SEO o ajustes de la página):
 *   Title: Load Trail Dump Trailer Rental | Duluth, GA | KC Trailer Rentals
 *   Meta:  Rent a Load Trail dump trailer with 2' side extensions (14,000 lb GVWR)
 *          in Duluth, GA. Hourly & daily rates, fully equipped, 24/7.
 */
...
$best_for = array(
  'Large landscaping and mulch jobs',
  'High-volume demolition debris',
  'Bulky, lightweight loads',
  'Bigger property cleanups',
);

$included = array(
  "2' walls + 2' extensions",
  'Hydraulic dump',
    ...
    <div class="grid items-center gap-12 lg:grid-cols-2">
      <div>
        ...
        <h1 class="mt-4 font-display text-4xl font-bold uppercase leading-[1.05] tracking-tight text-white sm:text-5xl">
          Load Trail Dump<br>— More Room, More Hauling.
        </h1>
        <p class="mt-5 max-w-xl text-lg leading-relaxed text-[#C7CDD3]">
          Taller walls and 2-foot extensions for big, bulky loads. 14,000 lb capacity,
          available 24/7.
        </p>
      ...
      <div class="aspect-[4/3] w-full overflow-hidden rounded-xl border border-white/10 bg-[#11161B] bg-cover bg-center shadow-2xl"
           ...
           role="img" aria-label="Load Trail dump trailer with 2-foot extensions"></div>
    </div>
  </div>
...
<section class="bg-[#F4F2ED] py-20">
  <div class="mx-auto grid max-w-6xl items-center gap-12 px-6 lg:grid-cols-2">
    ...
    <div class="relative aspect-[4/3] w-full overflow-hidden rounded-xl border border-[#1B2127]/10 shadow-xl">
      ...
      <img src="<?php echo esc_url($trailer_image_2); ?>" alt="Load Trail dump trailer detail" loading="lazy"
    ...
    <div>
      ...
      <h2 class="mt-3 font-display text-3xl font-bold uppercase tracking-tight text-[#1B2127] sm:text-4xl">
        More volume, same muscle
      </h2>
      <p class="mt-5 text-lg leading-relaxed text-[#5B6670]">
        When the job produces more than a standard dump can hold, the Load Trail steps up. The
        2-foot walls plus 2-foot extensions give you serious volume for mulch, demolition debris
        or large landscaping projects, with the same heavy-duty 14,000 lb rating.
      </p>
    </div>
  </div>
</section>
...
<section class="bg-[#1B2127] py-20">
  <div class="mx-auto max-w-5xl px-6 text-center">
    ...
    <h2 class="mt-3 font-display text-3xl font-bold uppercase tracking-tight text-white sm:text-4xl">
      14,000 lb GVWR · 7' × 14' × 2' walls + 2' ext
    </h2>
    <div class="mt-10 grid gap-5 sm:grid-cols-3">
      ...
      <div class="rounded-lg border border-white/10 bg-[#11161B] p-6">
        <div class="font-display text-4xl font-bold text-[#D7282F]">$170</div>
...
<section id="reserve" class="relative bg-[#11161B] py-20">
  ...
  <div class="relative mx-auto grid max-w-7xl items-start gap-12 px-6 lg:grid-cols-2">
    ...
    <div class="render-contact-form w-full" data-trailer="Load Trail Dump"></div>
  </div>
</section>
