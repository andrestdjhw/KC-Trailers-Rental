 ...
 *          insurance, deposit and a $45 booking fee. See how it works.
...
$steps = array(
  ...
  array('n' => '2', 'title' => 'Reserve', 'text' => 'Call us or use the form, and pay the $45 booking fee.'),
...
<section class="relative bg-[#1B2127]">
  ...
  <div class="relative mx-auto max-w-7xl px-6 py-16 lg:py-20">
    <div class="reveal max-w-3xl">
      ...
      <p class="mt-4 max-w-xl text-lg leading-relaxed text-[#C7CDD3]">Requirements, the booking fee, and how the whole thing works — in three short steps.</p>
    </div>
  </div>
    ...
    <div>
      ...
      <div class="reveal grid items-center gap-8 rounded-xl bg-[#1B2127] p-8 sm:grid-cols-[auto,1fr] sm:p-10">
        <div class="text-center sm:text-left">
          <div class="spec-figure font-display text-6xl font-bold text-[#D7282F]"><span data-countup="45" data-prefix="$">$45</span></div>
          <div class="mt-1 text-[13px] font-semibold uppercase tracking-[0.18em] text-[#9AA4AE]">Booking fee</div>
        </div>
        <p class="text-[17px] leading-relaxed text-[#C7CDD3]">
          A <span class="font-semibold text-white">$45 non-refundable booking fee</span> reserves your trailer. A credit card is required
          for the security deposit. Hourly and daily rates vary by trailer and by day of the week — see each trailer's page for current pricing.
        </p>
      </div>
...
<section class="bg-[#D7282F]">
  ...
  <div class="reveal mx-auto max-w-7xl px-6 py-16 text-center">
    ...
    <div class="mt-8 flex flex-wrap items-center justify-center gap-4">
      <a href="/contact" class="rounded-md bg-white px-7 py-3.5 font-display text-[15px] font-bold uppercase tracking-wide text-[#1B2127] transition-colors duration-[120ms] hover:bg-[#1B2127] hover:text-white">Reserve now</a>
