<?php
/**
 * Template Name: Trailer — Car Hauler 87
 * Página individual del remolque (URL sugerida: /car-hauler-87).
 * Asignar en: editor de la página → Atributos de página → Plantilla.
 * SEO (configurar en el plugin SEO o ajustes de la página):
 *   Title: Car Hauler Trailer Rental 87" | Duluth, GA | KC Trailer Rentals
 *   Meta:  Rent an 87" x 20' Load Trail car hauler (9,990 lb GVWR, 12k winch) in
 *          Duluth, GA. Move a car safely. Hourly & daily rates, 24/7.
 */
...
$trailer_image   = '/wp-content/uploads/2026/07/LoadTrailer87.webp';   // 1 → hero
$trailer_image_2 = '/wp-content/uploads/2026/07/LoadTrailer87About-.webp'; // 2 → bloque "About"
...
$best_for = array(
  'Moving a car between locations',
  'Buying or selling a vehicle',
  'Non-running or project cars',
    ...
    <div class="grid items-center gap-12 lg:grid-cols-2">
      <div>
        ...
        <h1 class="mt-4 font-display text-4xl font-bold uppercase leading-[1.05] tracking-tight text-white sm:text-5xl">
          Car Hauler 87"<br>— Move Vehicles with Confidence.
        </h1>
        <p class="mt-5 max-w-xl text-lg leading-relaxed text-[#C7CDD3]">
          20 feet of deck, a 12k winch and a ramp extension for low cars. Ready 24/7.
        </p>
      ...
      <div class="aspect-[4/3] w-full overflow-hidden rounded-xl border border-white/10 bg-[#11161B] bg-cover bg-center shadow-2xl"
           ...
           role="img" aria-label="Load Trail car hauler 87 inch by 20 foot"></div>
    </div>
  </div>
...
<section class="bg-[#F4F2ED] py-20">
  <div class="mx-auto grid max-w-6xl items-center gap-12 px-6 lg:grid-cols-2">
    ...
    <div class="relative aspect-[4/3] w-full overflow-hidden rounded-xl border border-[#1B2127]/10 shadow-xl">
      ...
      <img src="<?php echo esc_url($trailer_image_2); ?>" alt="Load Trail 87 inch car hauler detail" loading="lazy"
    ...
    <div>
      ...
      <h2 class="mt-3 font-display text-3xl font-bold uppercase tracking-tight text-[#1B2127] sm:text-4xl">
        Easy, dependable car hauling
      </h2>
      <p class="mt-5 text-lg leading-relaxed text-[#5B6670]">
        Hauling a car, a project vehicle or a non-runner? This 87" x 20' Load Trail makes loading
        easy with a 12,000 lb winch and a ramp extension that clears low front ends. A solid,
        dependable choice for sedans and standard vehicles.
      </p>
    </div>
  </div>
</section>
...
<section class="bg-[#1B2127] py-20">
  <div class="mx-auto max-w-5xl px-6 text-center">
    ...
    <p class="mt-3 text-[15px] text-[#9AA4AE]">12k lb winch · ramp extension</p>
    <div class="mt-10 grid gap-5 sm:grid-cols-3">
      <div class="rounded-lg border border-white/10 bg-[#11161B] p-6">
        <div class="font-display text-4xl font-bold text-[#D7282F]">$100</div>
        <div class="mt-1 text-[14px] font-semibold uppercase tracking-wide text-[#C7CDD3]">Mon–Thu (24h)</div>
      </div>
      <div class="rounded-lg border border-white/10 bg-[#11161B] p-6">
        <div class="font-display text-4xl font-bold text-[#D7282F]">$120</div>
...
<section id="reserve" class="relative bg-[#11161B] py-20">
  ...
  <div class="relative mx-auto grid max-w-7xl items-start gap-12 px-6 lg:grid-cols-2">
    ...
    <div class="render-contact-form w-full" data-trailer="Car Hauler 87&quot; x 20'"></div>
  </div>
</section>
